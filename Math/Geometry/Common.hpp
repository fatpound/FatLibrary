...
namespace fatpound::math::geometry
{
    ...
    static auto CompareDistance  (const DirectX::XMFLOAT2& p0, const DirectX::XMFLOAT2& p1) noexcept
    {
    ...
    static auto DistanceVector4  (const DirectX::XMVECTOR& p0, const DirectX::XMVECTOR& p1) noexcept
    {
